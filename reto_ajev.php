...
<script>(function(d, s, id) {
 ...
 <div style=" float: left; width:755px; background-color:#e8ebec; padding-left: 10px; height:120px; border-bottom: 1px solid #999; padding-top: 10px;"><span class="descp">¡Participa! Descárgate Hooptap (app gratis) en tu móvil y busca el reto: ¿Crees que eres emprendedor?<br />
