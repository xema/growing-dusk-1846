...
<script>(function(d, s, id) {
 ...
 <img src="http://prod.hooptap.com/preview/fb/ranking/heroku_file/images/cabecera_casa_blanca.jpg"  width="765px"></img>
   
 <div style="width: 100px; float: left; margin-left: 20px;" align="center" >
<ul style=" padding-left: 2px;">
<?php
$contents = file_get_contents('http://prod.hooptap.com/preview/fb/ranking/list_gamer.php?rid=216');
